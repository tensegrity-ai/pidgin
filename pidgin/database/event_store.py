...
class EventStore:
    ...
    def __init__(self, db_path: Optional[Path] = None):
        ...
        self.importer = ImportService(
            self.db, self.events, self.experiments,
            self.conversations, self.messages, self.metrics
        )
    ...
    def log_agent_name(self, conversation_id: str, agent_id: str, 
        ...
        self.conversations.log_agent_name(conversation_id, agent_id, chosen_name, turn_number)
    ...
    def import_experiment_from_jsonl(self, exp_dir: Path) -> ImportResult:
        ...
        """
        return self.importer.import_experiment_from_jsonl(exp_dir)

"""EventStore using repository pattern.

This implementation delegates to specialized repositories for better separation
...
class EventStore:
    """EventStore using repository pattern for better separation of concerns."""
    ...
    def __init__(self, db: AsyncDuckDB):
        ...
        logger.info("Initialized EventStore with repository pattern")

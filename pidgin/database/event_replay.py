...
class EventReplay:
    ...
    def replay_conversation(self, experiment_id: str, conversation_id: str, 
                          jsonl_path: Path) -> ConversationState:
    ...
    def _handle_conversation_start(self, state: ConversationState, 
                                 event: ConversationStartEvent) -> None:
    ...
    def _handle_conversation_end(self, state: ConversationState, 
                               event: ConversationEndEvent) -> None:
    ...
    def _handle_message_complete(self, state: ConversationState, 
                               event: MessageCompleteEvent) -> None:
    ...
    def _handle_system_prompt(self, state: ConversationState, 
                            event: SystemPromptEvent) -> None:

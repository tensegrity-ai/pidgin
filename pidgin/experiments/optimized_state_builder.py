# pidgin/experiments/optimized_state_builder.py
"""Optimized state builder that uses manifests for efficient monitoring."""
...
from ..experiments.state_builder import ExperimentState, ConversationState
from ..io.logger import get_logger

logger = get_logger("optimized_state_builder")


class OptimizedStateBuilder:
...
_state_builder = OptimizedStateBuilder()

def get_state_builder() -> OptimizedStateBuilder:

...
class CLIDisplayMixin:
    ...
    def show_header(self, title: str, subtitle: Optional[str] = None) -> None:
        ...
        panel = Panel(header_text, border_style="cyan", expand=False)
    ...
    def show_file_operation(
        self, operation: str, file_path: Path, success: bool = True
    ) -> None:
    ...
    def show_summary(
        self, title: str, stats: Dict[str, Any], show_panel: bool = True
    ) -> None:

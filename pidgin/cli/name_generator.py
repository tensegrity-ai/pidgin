...
ADJECTIVES = [
    "curious", "wandering", "seeking", "pondering", "observing",
    "dancing", "flowing", "shifting", "drifting", "echoing",
    "quiet", "gentle", "bold", "swift", "patient",
    "hidden", "bright", "ancient", "distant", "near",
    "spiral", "cyclic", "linear", "fractal", "quantum",
    "nested", "parallel", "serial", "woven", "tangled"
]

# Nouns that suggest patterns and phenomena
NOUNS = [
    "pattern", "signal", "echo", "wave", "pulse",
    "drift", "flow", "stream", "current", "tide",
    "spiral", "orbit", "path", "trace", "thread",
    "whisper", "murmur", "hum", "chord", "tone",
    "lattice", "web", "mesh", "grid", "field",
    "spark", "glow", "shimmer", "flicker", "gleam"
]

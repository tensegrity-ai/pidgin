...
HEDGE_WORDS = {
    ...
    'arguably', 'approximately', 'roughly', 'about', 'around', 'likely',
    'presumably', 'conceivably', 'potentially', 'virtually', 'practically'
}

AGREEMENT_MARKERS = {
    'yes', 'yeah', 'yep', 'sure', 'agreed', 'agree', 'exactly', 'precisely',
    'absolutely', 'definitely', 'certainly', 'indeed', 'right', 'correct',
    'true', 'affirmative', 'of course', 'naturally', 'obviously', 'totally',
    'completely', 'entirely', 'undoubtedly', 'clearly'
}

DISAGREEMENT_MARKERS = {
    'no', 'nope', 'not', 'disagree', 'wrong', 'incorrect', 'false', 'but',
    'however', 'although', 'though', 'actually', 'conversely', 'contrary',
    'unfortunately', 'negative', 'nah', 'doubt', 'doubtful', 'nevertheless',
    'nonetheless', 'alternatively', 'rather', 'instead', 'oppose', 'reject'
}

POLITENESS_MARKERS = {
    'please', 'thank', 'thanks', 'sorry', 'excuse', 'pardon', 'appreciate',
    'grateful', 'kindly', 'respectfully', 'humbly', 'graciously', 'sincerely',
    'apologize', 'apologies', 'forgive', 'regret', 'welcome'
}

...
class ErrorTracker:
                                ...
                                if timestamp_str:
                                    ...
                                    if timestamp >= cutoff_time:
                                        ...
                                        if "conversation_id" in event:
                                            error_info["conversation_id"] = event["conversation_id"]
                                        if "experiment_id" in event:
                                            error_info["experiment_id"] = event["experiment_id"]
    ...
    def check_error_resolved(self, error: Dict[str, Any], all_errors: List[Dict[str, Any]]) -> bool:
        ...
        if exp_id or conv_id:
            ...
            for other in all_errors:
                ...
                if (
                    (exp_id and other.get("experiment_id") == exp_id) or

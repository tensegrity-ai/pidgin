...
def get_smart_convergence_defaults(
    ...
    is_api_model_a = model_config_a and model_config_a.provider not in ["local", "silent"]
    is_api_model_b = model_config_b and model_config_b.provider not in ["local", "silent"]

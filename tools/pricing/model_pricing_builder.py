...
def build_openai_pricing() -> List[Dict]:
    ...
    models = [
        ...
        {"model_id": "gpt-5-mini", "input": 0.25, "cached_input": 0.025, "output": 2.00},
        {"model_id": "gpt-5-nano", "input": 0.05, "cached_input": 0.005, "output": 0.40},
        {"model_id": "gpt-5-chat-latest", "input": 1.25, "cached_input": 0.125, "output": 10.00},
        
        # GPT-4.1 series
        {"model_id": "gpt-4.1", "input": 2.00, "cached_input": 0.50, "output": 8.00},
        {"model_id": "gpt-4.1-mini", "input": 0.40, "cached_input": 0.10, "output": 1.60},
        {"model_id": "gpt-4.1-nano", "input": 0.10, "cached_input": 0.025, "output": 0.40},
        
        # GPT-4o series
        {"model_id": "gpt-4o", "input": 2.50, "cached_input": 1.25, "output": 10.00},
        {"model_id": "gpt-4o-2024-05-13", "input": 5.00, "cached_input": None, "output": 15.00},
        {"model_id": "gpt-4o-audio-preview", "input": 2.50, "cached_input": None, "output": 10.00},
        {"model_id": "gpt-4o-realtime-preview", "input": 5.00, "cached_input": 2.50, "output": 20.00},
        {"model_id": "gpt-4o-mini", "input": 0.15, "cached_input": 0.075, "output": 0.60},
        {"model_id": "gpt-4o-mini-audio-preview", "input": 0.15, "cached_input": None, "output": 0.60},
        {"model_id": "gpt-4o-mini-realtime-preview", "input": 0.60, "cached_input": 0.30, "output": 2.40},
        
        # O-series reasoning models
        {"model_id": "o1", "input": 15.00, "cached_input": 7.50, "output": 60.00},
        {"model_id": "o1-mini", "input": 3.00, "cached_input": 1.50, "output": 12.00},  # From API docs
        ...
        {"model_id": "o3-deep-research", "input": 10.00, "cached_input": 2.50, "output": 40.00},
        ...
        {"model_id": "gpt-4-32k", "input": 60.00, "cached_input": None, "output": 120.00},
        {"model_id": "gpt-4-turbo", "input": 10.00, "cached_input": None, "output": 30.00},
        {"model_id": "gpt-4-turbo-preview", "input": 10.00, "cached_input": None, "output": 30.00},
        
        # GPT-3.5 series
        {"model_id": "gpt-3.5-turbo", "input": 0.50, "cached_input": None, "output": 1.50},
        {"model_id": "gpt-3.5-turbo-16k", "input": 3.00, "cached_input": None, "output": 4.00},
    ]
...
def build_anthropic_pricing() -> List[Dict]:
    ...
    models = [
        ...
        {"model_id": "claude-3-opus-20240229", "display_name": "Claude 3 Opus",
         "input": 15.00, "cached_input": 1.50, "output": 75.00},
        
        # Claude 3 Haiku
        {"model_id": "claude-3-haiku-20240307", "display_name": "Claude 3 Haiku",
         "input": 0.25, "cached_input": 0.03, "output": 1.25},
    ]
...
def build_google_pricing() -> List[Dict]:
    ...
    models = [
        # Gemini 2.0
        {"model_id": "gemini-2.0-flash-exp", "display_name": "Gemini 2.0 Flash",
         "input": 0.0, "output": 0.0, "tier": "free", "rpm": 10, "tpm": 1000000},
        
        # Gemini 1.5
        {"model_id": "gemini-1.5-pro", "display_name": "Gemini 1.5 Pro",
         "input": 3.50, "cached_input": 0.875, "output": 10.50},  # Paid tier
        {"model_id": "gemini-1.5-flash", "display_name": "Gemini 1.5 Flash",
         "input": 0.075, "cached_input": 0.01875, "output": 0.30},  # Paid tier
    ]
...
def build_xai_pricing() -> List[Dict]:
    """xAI Grok pricing"""
    models = [
        {"model_id": "grok-2-1212", "display_name": "Grok 2",
         "input": 2.00, "output": 10.00},
        {"model_id": "grok-2-vision-1212", "display_name": "Grok 2 Vision",
         "input": 2.00, "output": 10.00},
        {"model_id": "grok-beta", "display_name": "Grok Beta",

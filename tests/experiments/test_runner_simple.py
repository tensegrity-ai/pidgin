...
class TestExperimentRunnerBasic:
    ...
    def test_setup_output_and_console_verbose_mode(self, temp_output_dir, sample_experiment_config):
    ...
    def test_setup_output_and_console_tail_mode(self, temp_output_dir, sample_experiment_config):
    ...
    def test_setup_output_and_console_no_display(self, temp_output_dir, sample_experiment_config):
    ...
    @pytest.mark.asyncio
    async def test_create_agents_and_providers_success(self, temp_output_dir, sample_experiment_config):
        ...
        with patch('pidgin.experiments.runner.get_model_config', return_value=mock_model_config), \
             patch('pidgin.experiments.runner.get_provider_for_model') as mock_get_provider:
            
            mock_provider = AsyncMock()
            mock_get_provider.return_value = mock_provider
            
            agents, providers = await runner._create_agents_and_providers(sample_experiment_config)
    ...
    @pytest.mark.asyncio
    async def test_create_agents_and_providers_invalid_config(self, temp_output_dir, sample_experiment_config):
    ...
    @pytest.mark.asyncio
    async def test_create_agents_and_providers_provider_failure(self, temp_output_dir, sample_experiment_config):
    ...
    @pytest.mark.asyncio 
    async def test_run_parallel_conversations_with_daemon_stop(self, temp_output_dir, sample_experiment_config, mock_daemon):
    ...
    @pytest.mark.asyncio
    async def test_create_and_run_conductor_basic(self, temp_output_dir, sample_experiment_config):
        ...
        # Mock dependencies
        mock_agents = {
            "agent_a": Mock(spec=Agent),
            "agent_b": Mock(spec=Agent)
        }
        mock_providers = {
            "agent_a": AsyncMock(),
            "agent_b": AsyncMock()
        ...
        with patch('pidgin.experiments.runner.build_initial_prompt', return_value="Test prompt"), \

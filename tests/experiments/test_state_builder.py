...
from pidgin.experiments.state_types import ExperimentState, ConversationState
...
class TestStateBuilder:
    ...
    def test_list_experiments_with_experiments(self, temp_dir, sample_manifest):
        ...
        with patch.object(builder, 'get_experiment_state', side_effect=[mock_state1, mock_state2]):
            result = builder.list_experiments(temp_dir)
    ...
    def test_build_from_manifest_success(self, temp_dir, sample_manifest):
        ...
        with patch.object(builder, '_get_conversation_timestamps', return_value={}), \
             patch.object(builder, '_get_last_convergence', return_value=0.5), \
             patch.object(builder, '_get_truncation_info', return_value={'count': 1, 'last_turn': 2}):

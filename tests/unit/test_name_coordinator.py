...
class TestNameCoordinator:
    ...
    def test_extract_chosen_name_bracketed_fallback(self, coordinator):
        ...
        assert coordinator.extract_chosen_name("Hi, I'm [Rex]. Nice to meet you!") == "Rex"
        assert coordinator.extract_chosen_name("Let's start. [Sam] reporting for duty.") == "Sam"
    ...
    def test_extract_chosen_name_no_match(self, coordinator):
        ...
        assert coordinator.extract_chosen_name("I don't have a preference for names") is None
    ...
    def test_assign_display_names_no_config(self, mock_get_config, coordinator):
        ...
        # Create agents
        agent_a = Agent(id="agent_a", model="unknown-model-1")
        agent_b = Agent(id="agent_b", model="unknown-model-2")

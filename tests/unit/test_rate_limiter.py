...
class TestStreamingRateLimiter:
    ...
    def test_load_limits_custom_partial(self):
        ...
        custom_limits = {
            "anthropic": {
                "requests_per_minute": 25  # Only override one value
            },
            "new_provider": {
                "requests_per_minute": 100,
        ...
        with patch('pidgin.core.rate_limiter.get_config') as mock_config:
            ...
            assert limiter.rate_limits["anthropic"]["tokens_per_minute"] == limiter.DEFAULT_RATE_LIMITS["anthropic"]["tokens_per_minute"]

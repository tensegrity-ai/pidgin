...
class TestConversationEvents:
    ...
    def test_event_serialization(self):
        ...
        # Note: event_type is added by EventBus when serializing, not by event itself
...
class TestTurnEvents:
    ...
    def test_turn_start_event(self):
        ...
        event = make_turn_start_event(conversation_id="test_123", turn_number=3)
    ...
    def test_turn_complete_event(self):
        ...
        event = make_turn_complete_event(
            conversation_id="test_123", turn_number=3, convergence_score=0.75
        )

...
from pidgin.ui.display_utils import DisplayUtils, NORD_COLORS, default_display
...
class TestCalculatePanelWidth:
    ...
    def test_calculate_panel_width_string_content(self):
        ...
        # Short content
        width = display._calculate_panel_width("Hello", "Test", min_width=30, max_width=60)
        assert width == 30  # Should use min_width
        
        # Long content
        long_content = "This is a very long line that should determine the width"
        width = display._calculate_panel_width(long_content, "Test", min_width=30, max_width=60)
        assert width == 60  # Should use max_width
        
        # Medium content
        medium_content = "Medium length content"
        width = display._calculate_panel_width(medium_content, "Test", min_width=20, max_width=80)
    ...
    def test_calculate_panel_width_multiline_content(self):
        ...
        width = display._calculate_panel_width(multiline, "Test", min_width=30, max_width=80)
    ...
    def test_calculate_panel_width_title_consideration(self):
        ...
        width = display._calculate_panel_width(content, long_title, min_width=20, max_width=80)
    ...
    def test_calculate_panel_width_constraints(self):
        ...
        width = display._calculate_panel_width(very_long_content, "", min_width=20, max_width=50)
        assert width == 50
...
class TestDefaultDisplay:
    ...
    def test_convenience_functions_exist(self):
        ...
        from pidgin.ui.display_utils import (
            error, warning, info, success, api_error, api_key_error,
            dim, status, note
        )
    ...
    def test_convenience_functions_work(self):
        ...
        from pidgin.ui.display_utils import error, info, default_display
...
class TestNordColors:
    ...
    def test_nord_colors_are_valid_hex(self):
        ...
        for color_name, color_value in NORD_COLORS.items():
            assert hex_pattern.match(color_value), f"{color_name} has invalid hex value: {color_value}"
...
class TestIntegrationScenarios:
    ...
    def test_multiple_message_types(self):
        ...
        assert console.print.call_count > 4  # Each message type calls print multiple times
    ...
    def test_panel_width_consistency(self):
        ...
        assert console.print.call_count == 9  # 3 messages × 3 calls each (blank, panel, blank)

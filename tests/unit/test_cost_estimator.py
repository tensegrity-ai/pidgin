...
class TestCostEstimator:
    ...
    def test_estimate_message_cost_input(self, cost_estimator, sample_message):
        ...
        cost = cost_estimator.estimate_message_cost(sample_message, model, is_input=True)
    ...
    def test_estimate_message_cost_output(self, cost_estimator, sample_message):
        ...
        model = "claude-3-5-sonnet-20241022"
        cost = cost_estimator.estimate_message_cost(sample_message, model, is_input=False)
    ...
    def test_estimate_message_cost_unknown_model(self, cost_estimator, sample_message):
        ...
        cost = cost_estimator.estimate_message_cost(sample_message, "unknown-model", is_input=True)
    ...
    def test_estimate_message_cost_local_model(self, cost_estimator, sample_message):
        ...
        cost_input = cost_estimator.estimate_message_cost(sample_message, "local", is_input=True)
        cost_output = cost_estimator.estimate_message_cost(sample_message, "local", is_input=False)
    ...
    def test_estimate_message_cost_empty_message(self, cost_estimator):
        ...
        cost = cost_estimator.estimate_message_cost(empty_message, "claude-3-5-sonnet-20241022", is_input=True)
        assert cost == 0.0
    ...
    def test_estimate_conversation_cost_basic(self, cost_estimator):
        ...
        # Check calculations
        assert cost_breakdown["model_a_total"] == breakdown["model_a_input"] + breakdown["model_a_output"]
        assert cost_breakdown["model_b_total"] == breakdown["model_b_input"] + breakdown["model_b_output"]
        assert cost_breakdown["total"] == cost_breakdown["model_a_total"] + cost_breakdown["model_b_total"]
    ...
    def test_cost_calculation_accuracy(self, cost_estimator):
        ...
        cost = cost_estimator.estimate_message_cost(message, "claude-3-5-sonnet-20241022", is_input=True)
    ...
    def test_input_output_cost_difference(self, cost_estimator, sample_message):
        ...
        input_cost = cost_estimator.estimate_message_cost(sample_message, model, is_input=True)
        output_cost = cost_estimator.estimate_message_cost(sample_message, model, is_input=False)

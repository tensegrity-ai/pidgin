...
class TestTranscriptGenerator:
    ...
    def test_format_summary_metrics_with_missing_values(self, generator):
        ...
        token_data = {
            'total_tokens': 500,
            'total_cost_cents': None  # Missing cost
        }
    ...
    def test_generate_conversation_transcript_full(self, generator):
        ...
        generator._get_messages = Mock(return_value=[
            {
                'turn_number': 1,
                'agent_id': 'agent_a',
                'display_name': 'GPT',
        ...
        generator._get_turn_metrics = Mock(return_value=[
            {
                'turn_number': 1,
        ...
        generator._get_token_usage = Mock(return_value={
            'total_tokens': 15,
            'total_cost_cents': 1
        })
    ...
    def test_generate_experiment_transcripts(self, generator, tmp_path):
        ...
        generator._get_experiment_data = Mock(return_value={
        ...
        generator._get_conversations = Mock(return_value=[
            {'conversation_id': 'conv_1'}
        ])
        
        # Mock conversation transcript generation
        with patch.object(generator, 'generate_conversation_transcript', return_value="# Test Transcript"):

...
from pidgin.constants import (
    ...
    DEFAULT_CONVERGENCE_PROFILE, DEFAULT_CONVERGENCE_THRESHOLD, DEFAULT_CONVERGENCE_ACTION
)
...
class TestConfig:
    ...
    def test_init_with_defaults(self):
        ...
        assert config.get("conversation.convergence_threshold") == DEFAULT_CONVERGENCE_THRESHOLD
        assert config.get("conversation.convergence_action") == DEFAULT_CONVERGENCE_ACTION
    ...
    def test_save_with_path(self, tmp_path):
        ...
        assert saved_config["conversation"]["convergence_threshold"] == DEFAULT_CONVERGENCE_THRESHOLD
    ...
    def test_get_convergence_config_default_profile(self):
        ...
        assert conv_config["weights"] == DEFAULT_CONVERGENCE_WEIGHTS[DEFAULT_CONVERGENCE_PROFILE]

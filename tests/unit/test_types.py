...
from pidgin.core.types import (
    ConversationRole, InterventionSource, ConversationTurn,
...
class TestConversation:
    ...
    def test_basic_creation(self):
        ...
        agents = [
            Agent(id="a1", model="model1"),
            Agent(id="a2", model="model2")
        ]
        ...
        assert conv.agents == agents
        assert conv.messages == []
        assert isinstance(conv.started_at, datetime)
        assert conv.initial_prompt is None
    ...
    def test_with_messages(self):
        ...
        messages = [
            Message(role="user", content="Hi", agent_id="a1"),
            Message(role="assistant", content="Hello", agent_id="a2")
        ]
        ...
        assert conv.initial_prompt == "Start conversation"

...
class TestEventAwareProvider:
    ...
    @pytest.mark.asyncio
    async def test_handle_message_request_success(self, wrapper, event_bus, mock_provider):
        ...
        with patch('time.time', side_effect=[1000.0, 1000.1]):  # 100ms duration
            with patch('pidgin.providers.token_tracker.get_token_tracker', return_value=mock_tracker):
    ...
    @pytest.mark.asyncio
    async def test_handle_message_request_api_error(self, wrapper, event_bus, mock_provider):
    ...
    @pytest.mark.asyncio
    async def test_handle_message_request_non_retryable_error(self, wrapper, event_bus, mock_provider):
    ...
    @pytest.mark.asyncio
    async def test_token_usage_with_different_naming(self, wrapper, event_bus, mock_provider):

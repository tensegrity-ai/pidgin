...
class TestContextUtils:
    ...
    def test_apply_context_truncation_no_truncation(self):
        ...
        with patch(
            "pidgin.providers.context_utils.ProviderContextManager"
        ) as mock_manager:
            mock_instance = Mock()
    ...
    def test_apply_context_truncation_with_truncation(self):
        ...
        with patch(
            ...
            with patch("pidgin.providers.context_utils.logger") as mock_logger:
                result = apply_context_truncation(original_messages, "openai", "gpt-4")
    ...
    def test_apply_context_truncation_with_custom_logger(self):
        ...
        with patch(
            ...
            with patch(
                "pidgin.providers.context_utils.logging.getLogger"
            ) as mock_get_logger:

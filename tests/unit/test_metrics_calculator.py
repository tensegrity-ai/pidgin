...
class TestMetricsCalculator:
    ...
    def test_punctuation_metrics(self, calculator):
        ...
        assert (
            metrics["agent_a"]["punctuation_diversity"] > 0
        )  # Has diverse punctuation
    ...
    def test_pronoun_usage(self, calculator):
        ...
        metrics = calculator.calculate_turn_metrics(
            0, first_person_msg, second_person_msg
        )
    ...
    def test_turn_taking_balance(self, calculator):
        ...
        len_diff_balanced = abs(
            metrics_balanced["agent_a"]["message_length"]
            - metrics_balanced["agent_b"]["message_length"]
        )
        len_diff_imbalanced = abs(
            metrics_imbalanced["agent_a"]["message_length"]
    ...
    def test_calculate_repetition_edge_cases(self, calculator):
        ...
        # Test case where current words completely overlap with previous
        ...
        # Current: {'hello'}, Previous: {'hello'}
        # Overlap: {'hello'} - should be 100% repetition
        repetition = calculator._calculate_repetition(["hello"], "agent_a", 1)
        assert repetition == 1.0  # Should return 1.0 when all words are repeated
        ...
        # Overlap: {'world'} - 1 out of 2 words repeated = 50%
        ...
        # Current: {'hello', 'new'}
        # Previous: {'hello', 'world'}
        # Overlap: {'hello'} - 1 out of 2 words repeated = 50%

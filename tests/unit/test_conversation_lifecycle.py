...
class TestEventSystemInitialization:
    ...
    async def test_provider_wrapping(self, tmp_path):
        ...
        assert lifecycle.wrapped_providers["agent_a"].provider == base_providers["agent_a"]
        assert lifecycle.wrapped_providers["agent_b"].provider == base_providers["agent_b"]
...
class TestEventEmission:
    ...
    async def test_emit_start_events(self, tmp_path):
        ...
        system_prompts = {
            "agent_a": "System prompt A",
            "agent_b": "System prompt B"
        }

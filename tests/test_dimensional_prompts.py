...
class TestDimensionalPromptGenerator:
    ...
    def test_basic_dimensions(self):
        ...
        assert "Hello! I'm excited to explore the fundamental nature of reality together." in prompt
        ...
        assert "I'd like to help you understand how we communicate and create meaning." in prompt
    ...
    def test_neutral_context(self):
        ...
        assert "Hello! I'm looking forward to discussing the creative process and imagination." in prompt
    ...
    def test_thought_experiments_specific(self):
        ...
        prompt = self.generator.generate("interview:thought_experiments", experiment="trolley_problem")
    ...
    def test_unknown_experiment(self):
        ...
        with pytest.raises(ValueError) as exc_info:
            self.generator.generate("debate:thought_experiments", experiment="fake_experiment")
    ...
    def test_energy_integration(self):
        ...
        # Passionate energy
        passionate = self.generator.generate("collaboration:science:exploratory:passionate")

...
class TestContextWindowManager:
    ...
    def test_truncation_point(self):
        ...
        with patch.object(cm, 'context_limits', {"test-model": 1000}):
            truncation_point = cm.get_truncation_point(messages, "test-model", target_percentage=50)
...
class TestContextLimitHandling:
    ...
    def test_different_model_limits(self):
        ...
        claude_capacity = cm.get_remaining_capacity(large_messages, "claude-4-opus-20250514")
